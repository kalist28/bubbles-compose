...
import io.github.kalist28.bubbles.core.isReduceTransparencyEnabled
import io.github.kalist28.bubbles.core.theme.BubblesTheme
import io.github.kalist28.bubbles.effect.haze
import kotlin.jvm.JvmInline

/**
 * Scaffold implements the basic bubbles and material design visual layout structure.
 *
 * This component provides API to put together several bubbles components to construct your
 * screen, by ensuring proper layout strategy for them and collecting necessary data so these
 * components will work together correctly.
 *
 * @param modifier the [Modifier] to be applied to this scaffold
 * @param topBar top app bar of the screen, typically a [BubblesTopAppBar]
 * @param bottomBar bottom bar of the screen, typically a [BubblesTopAppBar]
...
fun BubblesScaffold(
    ...
    containerColor: Color = BubblesScaffoldDefaults.containerColor,
    contentColor: Color = BubblesScaffoldDefaults.contentColor,
    contentWindowInsets: WindowInsets = BubblesScaffoldDefaults.contentWindowInsets,
    appBarsBlurAlpha: Float = BubblesScaffoldDefaults.AppBarsBlurAlpha,
    appBarsBlurRadius: Dp = BubblesScaffoldDefaults.AppBarsBlurRadius,
...
/**
 * Object containing various default values for [BubblesScaffold] component.
 */
@Immutable
object BubblesScaffoldDefaults {
    ...
    val containerColor: Color
        @Composable
        @ReadOnlyComposable
        get() = BubblesTheme.colorScheme.systemBackground

    val contentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = BubblesTheme.colorScheme.label
}
...
internal val LocalAppBarsBlurAlpha =
    compositionLocalOf {
        BubblesScaffoldDefaults.AppBarsBlurAlpha
    }

internal val LocalAppBarsBlurRadius =
    compositionLocalOf {
        BubblesScaffoldDefaults.AppBarsBlurRadius
    }
