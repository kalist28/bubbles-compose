...
import io.github.kalist28.bubbles.core.BubblesHapticFeedback
...
import io.github.kalist28.bubbles.core.theme.systemGray
 ...
 * @param colors [BubblesSliderColors] that will be used to resolve the colors used for this slider in
 * different states. See [BubblesSliderDefaults.colors].
...
fun BubblesSlider(
    ...
    colors: BubblesSliderColors = BubblesSliderDefaults.defaultColorsFor(steps),
 ...
 * @param colors [BubblesSliderColors] that will be used to determine the color of the Range Slider
 * parts in different state. See [BubblesSliderDefaults.colors] to customize.
 */
@Composable
fun BubblesRangeSlider(
        ...
        remember(valueRange) {
            SliderDraggableState {
                ...
                if (steps > 0) {
                    if (prevValue != new) {
                        prevValue = new
                        haptic.performHapticFeedback(BubblesHapticFeedback.SelectionChanged)
                    }
                }
...
/**
 * Object to hold defaults used by [BubblesSlider]
 */
@Stable
object BubblesSliderDefaults {
    /**
     * Creates a [BubblesSliderColors] that represents the different colors used in parts of the
     * [BubblesSlider] in different states.
     *
    ...
    ): BubblesSliderColors = BubblesSliderColors(
    ...
    fun colorsSteps(
        thumbColor: Color = BubblesColors.White,
        activeTrackColor: Color = BubblesColors.systemGray,
    ...
    /**
     * The Default thumb for [BubblesSlider] and [BubblesRangeSlider]
     *
     ...
     * @param colors [BubblesSliderColors] that will be used to resolve the colors used for this thumb in
     * different states. See [BubblesSliderDefaults.colors].
    ...
    fun Thumb(
        interactionSource: MutableInteractionSource,
        modifier: Modifier = Modifier,
        colors: BubblesSliderColors = colors(),
        enabled: Boolean = true,
    ...
    /**
     * The Default track for [BubblesSlider] and [BubblesRangeSlider]
     *
     ...
     * @param colors [BubblesSliderColors] that will be used to resolve the colors used for this track in
     * different states. See [BubblesSliderDefaults.colors].
     * @param enabled controls the enabled state of this slider. When `false`, this component will
     * not respond to user input, and it will appear visually disabled and disabled to
     * accessibility services.
...
@Immutable
class BubblesSliderColors internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other == null || other !is BubblesSliderColors) return false
...
/**
 * Class that holds information about [BubblesSlider]'s and [BubblesRangeSlider]'s active track
...
class SliderPositions(
     ...
     * start to thumb for a [BubblesSlider] and start thumb to end thumb for a [BubblesRangeSlider].
     */
