 ...
 * [androidx.compose.foundation.Image] instead. For a clickable icon, see [BubblesIconButton].
 *
...
private val DefaultIconSizeModifier = Modifier.size(BubblesIconDefaults.LargeSize)
